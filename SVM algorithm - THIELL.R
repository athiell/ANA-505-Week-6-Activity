...
#How did the model do? The missclassification rate for this algorithm was very low, therefore it was a great fit
#What is the accuracy rate? = 1 - missclassification rate = 1 - .027 = .973= 97.3%
